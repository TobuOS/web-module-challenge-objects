...
console.log(createMenuItem('soup', 4, 'Lunch'))
...
burger.discount = function(tier){
  if(tier === 'teacher' || tier === 'student'){
...
console.log(addReview(reviews, 'Tristan', '2',"eh, go somewhere else"))
